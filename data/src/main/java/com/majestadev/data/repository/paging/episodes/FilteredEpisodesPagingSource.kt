...
class FilteredEpisodesPagingSource(
    private val episodeFilter: EpisodeFilter,
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, EpisodeDetails> {
        ...
        try {
            network.getFilteredEpisodes(episodeFilter, page).apply {
            ...
            cache.getFilteredEpisodes(episodeFilter).apply {
